...
public class RabbitMqInit {
	...
	/**
	 * 个人mq-交换机，queue name，routing key
	 */
	private static String PERSON_MQ_NAME = "P_P_D_W";
	...
	public void initConSumer(){
		RabbitMqUtil.getRabbitMQFactory().topicExchangeBindingqueue(PERSON_MQ_NAME, PERSON_MQ_NAME, PERSON_MQ_NAME);
		...
		try {
			consumer.onMessage(mqChannelDataHandler, PERSON_MQ_NAME);
		} catch (Exception e) {
