/*
package cn.com.dhcc.creditquery.person.queryweb.controller.rptinfoquery;
...
@Slf4j
@Controller
@RequestMapping(value = "/rptinfoquery")
public class RptInfoQueryController extends BaseController{
	private static final String PREFIX = "rptinfoquery/";
	@Autowired
