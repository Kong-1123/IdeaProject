/*
package cn.com.dhcc.creditquery.person.queryweb.controller.perinfoupdateinfoquery;
...
@Slf4j
@Controller
@RequestMapping(value = "/perinfoupdateinfoquery")
public class PerinfoUpdateInfoQueryController extends BaseController{
	private static final String PREFIX = "perinfoupdateinfoquery/";
	@Autowired
