/*
package cn.com.dhcc.creditquery.person.queryweb.controller.feedbackdownloadquery;
...
@Slf4j
@Controller
@RequestMapping(value = "/feedbackdownloadquery")
public class FeedBackDownLoadQueryController extends BaseController{
	private static final String PREFIX = "feedbackdownloadquery/";
	@Autowired
