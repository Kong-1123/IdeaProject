/*
package cn.com.dhcc.creditquery.person.queryweb.controller.keyinfoquery;
...
@Slf4j
@Controller
@RequestMapping(value = "/keyinfoquery")
public class KeyInfoQueryController extends BaseController{
	private static final String PREFIX = "keyinfoquery/";
	@Autowired
