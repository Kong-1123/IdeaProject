/*
package cn.com.dhcc.creditquery.person.queryweb.controller.resultqueryandsummary;
...
@Slf4j
@Controller
@RequestMapping(value = "/resultqueryandsummary")
public class ResultQueryAndSummaryController extends BaseController{
	private static final String PREFIX = "resultqueryandsummary/";
	@Autowired
