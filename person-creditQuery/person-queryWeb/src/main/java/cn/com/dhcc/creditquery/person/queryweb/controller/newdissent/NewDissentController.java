/*
package cn.com.dhcc.creditquery.person.queryweb.controller.newdissent;
...
@Slf4j
@Controller
@RequestMapping(value = "/newdissent")
public class NewDissentController extends BaseController{
	private static final String PREFIX = "newdissent/";
	@Autowired
