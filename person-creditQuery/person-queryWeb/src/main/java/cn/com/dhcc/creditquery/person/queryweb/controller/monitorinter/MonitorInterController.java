package cn.com.dhcc.creditquery.person.queryweb.controller.monitorinter;
...
import cn.com.dhcc.creditquery.person.businessmonitor.service.CpqBusinessMonitorService;
...
import cn.com.dhcc.creditquery.person.queryweb.vo.MonitorInterVo;
import cn.com.dhcc.creditquery.person.queryweb.vo.OneDayQueryVo;
import cn.com.dhcc.creditquery.person.queryweb.vo.QueryVolumResultVo;
...
/**
 * This calss is the Controller class of the cpq_monitorinter 
 * 
 * @author drj
 *
 */
...
public class MonitorInterController extends BaseController {
	...
	@Autowired
	private CpqBusinessMonitorService monitorInterService;
	...
	public MonitorInterVo getQueryConfigParam() {
		...
		String maxNum = ConfigUtil.getQueryCountMaxNum();
		String time = ConfigUtil.getTimeInterval();
	...
	public MonitorInterVo realTimeQueryGauge(HttpServletRequest request) {
		...
		try {
			String orgCode = UserConfigUtils.getDeptCode(request);
			Long time = Long.parseLong(ConfigUtil.getTimeInterval());
