...
@Slf4j
@Controller
@RequestMapping(value = "/recheckpolicy")
public class RecheckController  extends BaseController{
	private static Logger log = LoggerFactory.getLogger(RecheckController.class);
	private static final String PREFIX = "recheckpolicy/";
	@Autowired
...
/**
	...
	public String list(QueryReq queryReq) {
		WorkflowControl workflowControl = inquiryPolicyService.recheckControl(queryReq);
