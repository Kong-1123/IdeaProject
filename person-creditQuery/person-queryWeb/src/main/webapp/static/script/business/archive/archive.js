...
function bindBtn(obj) {
	...
	$(".btnWrap .reportsearchBtn").bind("click", function() {
		if ($("#grid-data tbody .active").length !=1 ) {
			...
			var creditUrl = encodeURI( obj.listObj.tabs[0].flowUrl + '?certNo=' + parentObj.cretNo + '&archiveId=' + parentObj.id + '&certType=' + parentObj.cretType + '&clientName=' + parentObj.clientName);
