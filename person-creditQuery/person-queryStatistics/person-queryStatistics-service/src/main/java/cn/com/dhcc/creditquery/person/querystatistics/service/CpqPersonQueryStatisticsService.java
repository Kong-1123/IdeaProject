 ...
 */
package cn.com.dhcc.creditquery.person.querystatistics.service;
 ...
 * @date 2019年2月16日
 */
public interface CpqPersonQueryStatisticsService {
	/**
	 ...
	 * @date 2019年2月16日
	 */
	CpqQueryStatisticsBo findQueryStatisticsById(String queryStatisticId);
     /**
      * 分页查询
      * @param searchParams
      * @param pageNumber
      ...
      * @date 2019年2月16日
      */
	Page<CpqQueryStatisticsBo> getQueryStatisticPage(Map<String, Object> searchParams, int pageNumber, int pageSize, String direction,
			String... orderBy);
    /**
     * 按用户/机构统计查询结果记录
     * @param searchParams
	 ...
	 * @date 2019年2月16日
	 */
	CpqAlertBo findCpqAlertById(String alertId);
    /**
     * 分页查询(按预警统计)
     * @param searchParams
     * @param pageNumber
	...
	Page<CpqAlertBo> getCpqAlertPage(Map<String, Object> searchParams, int pageNumber, int pageSize, String direction,
			String... orderBy);
	 ...
	 * @date 2019年2月16日
	 */
	List<CpqAlertBo> findCpqAlertsByParams(Map<String, Object> searchParams);
    /**
     * 按预警原因分组统计预警记录
     * @param AlertReason
	 * @param deptCodes
     ...
     * @date 2019年2月16日
     */
	Integer findCpqAlertGroupbyAleratReason(String AlertReason ,List<String> deptCodes);
	/**
	 * 根据机构及统计方式查询预警信息 
	 ...
	 * @date 2019年2月16日
	 */
	List<CpqAlertBo> findCpqAlerts(String queryOrgScope,String deptCode, Date alertBeginDate,Date alertEndDate);
	 ...
	 * @date 2019年2月28日
	 */
	void updateAlert(CpqAlertBo alter);
	/**
	 * 解锁用户
	 * @param alter
	 * @author yuzhao.xue
	 * @date 2019年2月28日
	 */
	void unlockUser(CpqAlertBo alter);
	/**
	 * 清空预警次数
	 * @param userName
	 * @author yuzhao.xue
	 ...
	 * @date 2019年2月28日
	 */
	void lockedUser(CpqAlertBo alter);
	/**
	 * @param ids
	 * @return
	 * @author yuzhao.xue
	 * @date 2019年2月28日
	 */
	List<CpqAlertBo> findByIds(List<String> ids);
}