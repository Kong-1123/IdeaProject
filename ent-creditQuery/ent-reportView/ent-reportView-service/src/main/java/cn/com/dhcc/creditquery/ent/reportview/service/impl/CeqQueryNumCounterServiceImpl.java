...
import cn.com.dhcc.creditquery.ent.reportview.service.CeqQueryNumCounterService;
...
@Service
@Slf4j
public class CeqQueryNumCounterServiceImpl implements CeqQueryNumCounterService {
	...
	public void creditUserPasswordErrorRecord(String creditUser, boolean blean, String message) {
		try {
			log.info("CpqQueryNumCounter service creditUserPasswordErrorRecord ER_CREDITUSER", EntCacheConstant.ER_CREDITUSER);
			RMap<String, String> cache = null;
			cache = redis.getMap(EntCacheConstant.ER_CREDITUSER);
