...
public class CeqSingleResultTask implements java.io.Serializable {
	...
	/** default constructor */
	public CeqSingleResultTask() {
	}


	public CeqSingleResultTask(String resCode, String resMsg) {
		super();
		this.resCode = resCode;
		this.resMsg = resMsg;
	}

	public CeqSingleResultTask(String id, String reqId, String resCode, String resMsg, String htmlStr, String xmlStr,
	...
	public String toString() {
		return "CpqSingleResult [id=" + id + ", reqId=" + reqId + ", resCode=" + resCode + ", resMsg=" + resMsg
