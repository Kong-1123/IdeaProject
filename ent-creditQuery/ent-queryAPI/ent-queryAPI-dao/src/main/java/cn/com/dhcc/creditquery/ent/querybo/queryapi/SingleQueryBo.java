...
public class SingleQueryBo implements Serializable {
	...
	@Length(max = 80, message = "querierName长度最大为80;")
	...
	@EnumJudgeRules(message = "querierCertype不在字典中", type = "registertype_ceq", isPerson = false)
	...
	@EnumJudgeRules(message = "queryReason不在字典中", type = "qryReason_ceq",isPerson = false)
	...
	@EnumJudgeRules(message = "queryFormat不在字典中", type = "qryFormat_ceq",isPerson = false)
	...
	@EnumJudgeRules(message = "reportType不在字典中", type = "reportFormat_ceq",isPerson = false)
	...
	@EnumJudgeRules(message = "syncFlag不在字典中", type = "syncFlag",isPerson = false)
	...
	@EnumJudgeRules(message = "asyncQueryFlag不在字典中", type = "asyncQueryFlag",isPerson = false)
	...
	@EnumJudgeRules(message = "reportVersion不在字典中", type = "reportVersion_ceq",isPerson = false)
	...
	public SingleQueryBo(String querierName, String querierCertype, String querierCertno, String queryReason,
			...
			String recheckUser, String userIp, String userMac, String reportVersion, String reqId, String msgNo,
