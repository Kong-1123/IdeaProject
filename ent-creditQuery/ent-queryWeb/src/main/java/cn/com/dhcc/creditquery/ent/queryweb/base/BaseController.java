...
import cn.com.dhcc.creditquery.ent.queryweb.util.Servlets2;
import cn.com.dhcc.query.creditquerycommon.configutil.CeqConfigUtil;

public abstract class BaseController extends  BaseControllerAutowired{
...
//		log.info("page list "+page.getList());
	...
	public String getWithinDeptCode(String deptCode) throws ParseException, IOException {
		PlantFormInteractiveService plantFormInteractiveService = BaseControllerAutowired.getPlantFormInteractiveService();
	...
	public String getDeptCodeByParam(String deptCode) throws ParseException,IOException{
		String param=CeqConfigUtil.getVisibility();
		if(param.equals("0")){
			return deptCode;
		}else{
