package cn.com.dhcc.creditquery.ent.queryweb.controller.orgattr;
...
public class OrgAttrController extends BaseController {
	...
	@Autowired
	private CeqOrgAttrService service;
	...
	@ResponseBody
	public String saveOrUpdate(CeqOrgAttrBo orgAttr, HttpServletRequest request) {
	...
	public String findByOrgId(String orgId) {
		...
		CeqOrgAttrBo orgAttr = null;
		try {
			orgAttr = service.findByOrgId(orgId);
		} catch (Exception e) {
			orgAttr = new CeqOrgAttrBo();
